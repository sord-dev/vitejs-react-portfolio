  ...
  return (
    <div className={styles['social-list']}>
      <IconContext.Provider value={{ size: '3em' }}>
        <a href="https://www.linkedin.com/in/stefansyrett/">
          <AiFillLinkedin />
        </a>
        <a href="https://github.com/sord-dev">
          <AiFillGithub />
        </a>
        <a href="mailto:stefansyrett17@gmail.com">
          <AiFillMail />
        </a>
        <a href="https://docs.google.com/document/d/1YgO4AhYtWiec13T5Vxv4zgl8o1S-_MzFJfERLmmYk0Q/edit?usp=sharing">
          <AiFillBook />
        </a>
